...
const eksCluster = new pulumi.StackReference("organization/1-create-an-eks-cluster/default");
...
const tidbOperatorCRDs = new k8s.yaml.ConfigGroup("tidb-operator-crds",
    {files: "crds/*.yaml"},
    {provider: eksProvider},
);

// Deploy the TiDB Operator.
const tidbOperator = new k8s.helm.v3.Release("tidb-operator", {
        repositoryOpts: {
...
const tidbCluster = new k8s.yaml.ConfigGroup("tidb-cluster",
    {
